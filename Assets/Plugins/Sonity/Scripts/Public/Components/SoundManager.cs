...
//#endif
        ...
        /// <summary>
        /// <para> Returns the max distance (in Unity units) of the <see cref="SoundEventBase">SoundEvent</see>
        /// <para> (calculated from the <see cref="SoundContainerBase">SoundContainer</see> with the highest distance) </para>
        /// <para> Is scaled by the Distance Scale of the <see cref="SoundManagerBase">SoundManager</see> </para>
        /// <para> Returns 0 if the <see cref="SoundEventBase">SoundEvent</see> or <see cref="Transform"/> is null </para>
        /// <para> Returns Mathf.Infinity if any <see cref="SoundContainerBase">SoundContainer</see> have distance disabled </para>
        /// </summary>
        /// <returns> The max distance in Unity units </returns>
        public float GetMaxDistance(SoundEvent soundEvent) {
            return Internals.GetMaxDistance(soundEvent);
        }
        ...
        /// </param>
        public void SetGlobalSoundTagAtIndex(int index, SoundTag soundTag) {
            Internals.SetGlobalSoundTagAtIndex(index, soundTag);
        }
        ...
        public SoundTag GetGlobalSoundTagAtIndex(int index) {
            return (SoundTag)Internals.GetGlobalSoundTagAtIndex(index);
        }

#if SONITY_ENABLE_LEGACY_FUNCTIONS_GLOBAL_SOUNDTAG
        /// <summary>
        /// Sets the global <see cref="SoundTagBase">SoundTag</see>
        /// </summary>
        /// <param name='soundTag'>
        ...
        public void SetGlobalSoundTag(SoundTag soundTag) {
            Internals.SetGlobalSoundTagAtIndex(0, soundTag);
        }
        ...
        public SoundTag GetGlobalSoundTag() {
            return (SoundTag)Internals.GetGlobalSoundTagAtIndex(0);
        }
#endif
