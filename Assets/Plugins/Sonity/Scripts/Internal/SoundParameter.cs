...
namespace Sonity {
    ...
    /// <summary>
    /// If the <see cref="SoundEventBase">SoundEvent</see> should be forced to 2D (disabling distance and spatialization)
    /// </summary>
    public class SoundParameterForce2D : SoundParameterInternals {

        /// <summary>
        /// If the <see cref="SoundEventBase">SoundEvent</see> should be forced to 2D (disabling distance and spatialization)
        /// </summary>
        /// <param name="force2D"> If the <see cref="SoundEventBase">SoundEvent</see> should be forced to 2D (disabling distance and spatialization) </param>
        public SoundParameterForce2D(bool force2D = true) {
            Force2D = force2D;
            // Update Mode Once
            internals.type = SoundParameterType.Force2D;
        }

        /// <summary>
        /// If the <see cref="SoundEventBase">SoundEvent</see> should should be forced to 2D (disabling distance and spatialization)
        /// </summary>
        public bool Force2D {
            get { return internals.valueBool; }
            set {
