...
namespace Sonity.Internal {
    ...
    public class SoundEventPlayTypeInstance {
        ...
        private void SetDistance(Vector3 position, float maxRange, bool force2DEnabled) {
            // Avoid divide by zero
            if (distanceEnabled && !force2DEnabled && maxRange > 0f ) {
        ...
        public void SetCachedDistancesAndAngle(float maxRange, VoiceParameterInstance voiceParameter, bool forceUpdatePosition) {
            bool force2DEnabled = voiceParameter.currentModifier.force2DUse && voiceParameter.currentModifier.force2D;
            if (forceUpdatePosition || (ShouldFollowPosition(voiceParameter) && !force2DEnabled)) {
            ...
            SetDistance(cachedPosition, maxRange, force2DEnabled);
