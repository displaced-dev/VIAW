...
namespace Sonity.Internal {
    ...
    public class EditorTextModifier {
        ...
        public static readonly string modifiersTooltip = 
            $"Modifiers are used to control how {NameOf.SoundEvent}s " +
            $"are played (e.g. volume, polyphony, fade in length etc)." +
            $"Modifiers are only updated once when starting the {NameOf.SoundEvent}, not continuously" + EditorTrial.trialTooltip;
        ...
        public static readonly string volumeTooltip = 
            ...
            $"Note that Modifiers are only updated once when starting the {NameOf.SoundEvent}." +
            $"If you want realtime volume settings for a loop, use the {NameOf.SoundEvent} base, timeline or {NameOf.SoundContainer} volume." +
        ...
        public static readonly string distanceScaleWarning = $"Distance Scale is 0. The {NameOf.SoundEvent} will not be heard";
        public static readonly string distanceScaleNotEnabledText = "Distance is not enabled";
        public static readonly string distanceScaleNotEnabledTooltip = $"Distance is not enabled on the {NameOf.SoundContainer} of the {NameOf.SoundEvent}." + EditorTrial.trialTooltip;
        ...
        public static readonly string fadeInLengthTooltip = 
            ...
            "\n" +
            $"Is calculated using the time scale selected in the {NameOf.SoundManager}." 
            + priority + EditorTrial.trialTooltip;
        ...
        public static readonly string intensityNotEnabledTooltip = $"Intensity is not enabled on the {NameOf.SoundContainer} of the {NameOf.SoundEvent}." + EditorTrial.trialTooltip;
        ...
        public static readonly string distortionIncreaseTooltip = 
            ...
            "\n" +
            $"Distortion needs to be enabled on the {NameOf.SoundContainer} for this to have any effect." + EditorTrial.trialTooltip;
        ...
        public static readonly string distortionNotEnabledTooltip = $"Distortion is not enabled on the {NameOf.SoundContainer} of the {NameOf.SoundEvent}." + EditorTrial.trialTooltip;
        ...
        public static readonly string polyphonyTooltip = 
            ...
            "\n" +
            $"Modifier polyphony overrides the {NameOf.SoundEvent}s base Polyphony value."
            + priority + EditorTrial.trialTooltip;
        ...
        public static readonly string force2DLabel = "Force 2D";
        public static readonly string force2DTooltip =
            $"If the {NameOf.SoundEvent} should be forced to 2D (no distance, no spatialization, no panning)." + "\n" +
            "\n" +
            $"Useful for Player sounds so you don't have to use Follow Position." +
            "\n" +
            $"This enables you to use the \"PlayOneShot Optimization\" for these player sounds." + priority + EditorTrial.trialTooltip;
