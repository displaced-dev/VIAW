...
namespace Sonity.Internal {
    ...
    public class EditorTextSoundTrigger {
        ...
        public static readonly string soundTriggerTooltip =
            ...
            "\n" +
            $"All {NameOf.SoundTrigger} components are multi-object editable." + EditorTrial.trialTooltip;

        public static readonly string distanceRadiusLabel = "Distance Radius";
        public static readonly string distanceRadiusTooltip = $"Distance of the {NameOf.SoundEvent} (how far it should be heard)." + EditorTrial.trialTooltip;

        // Warning
        public static readonly string radiusHandleWarningNoDistance = $"No {NameOf.SoundContainer} has distance enabled";
        public static readonly string radiusHandleWarningNoSoundEvents = $"No {NameOf.SoundEvent}s";

        public static readonly string soundEventLabel = $"{NameOf.SoundEvent}";
        public static readonly string soundEventTooltip = $"The {NameOf.SoundEvent} which is played" + EditorTrial.trialTooltip;
        ...
        public static readonly string triggerTagTooltip = $"If enabled, the {NameOf.SoundEvent} will only play if the triggering object has a tag matching the selected tags." + EditorTrial.trialTooltip;
        ...
        public static readonly string collisionTagTooltip = $"If enabled, the {NameOf.SoundEvent} will only play if the collision object has a tag matching the selected tags." + EditorTrial.trialTooltip;
