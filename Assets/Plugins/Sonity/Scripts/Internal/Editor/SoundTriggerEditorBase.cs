...
#if SONITY_ENABLE_INTEGRATION_MULTIPLAYER
        public SerializedProperty multiplayerBroadcast;
#endif
...
#if SONITY_ENABLE_INTEGRATION_MULTIPLAYER
            multiplayerBroadcast = internals.FindPropertyRelative(nameof(SoundTriggerInternals.multiplayerBroadcast));
#endif
...
#if SONITY_ENABLE_INTEGRATION_MULTIPLAYER
            BeginChange();
            EditorGUILayout.PropertyField(multiplayerBroadcast, new GUIContent("Multiplayer Broadcast", ""));
            EndChange();
            EditorGUILayout.Separator();
#endif
