...
namespace Sonity.Internal {
    ...
    public class EditorTextSoundContainer {
        ...
        "\n" +
        $"All {NameOf.SoundContainer}s are multi-object editable." + EditorTrial.trialTooltip;
        ...
        public static readonly string presetsTooltip =
            ...
            "\n" +
            "Automatic Looping:" + "\n" +
            $"If the name of the selected {NameOf.SoundContainer}s contains “loop” then it will automatically enable “Loop”, “Follow Position”, “Stop if Transform is Null” and “Random Start Position”." + "\n" +
            "\n" +
        ...
        public static readonly string spatializationInfo3DSoundTooltip =
            $"All {NameOf.SoundContainer}s with Spatial Blend > 0 and Distance Enabled." + EditorTrial.trialTooltip;
        ...
        public static readonly string spatializationInfo2DSoundTooltip =
            $"All {NameOf.SoundContainer}s with Spatial Blend == 0 and Distance Disabled." + EditorTrial.trialTooltip;
        ...
        public static readonly string spatializationInfoSelectSCTooltip =
            $"Selects {NameOf.SoundContainer}s matching the specific settings." + EditorTrial.trialTooltip;
        ...
        public static readonly string spatializationInfoSelectAllSCTooltip =
            $"Selects All {NameOf.SoundContainer}s in the same folder disregarding subfolders." + EditorTrial.trialTooltip;
        ...
        public static readonly string spatializationInfoSelectACTooltip =
            $"Selects AudioClips of the {NameOf.SoundContainer}s matching the specific settings." + EditorTrial.trialTooltip;
        ...
        public static readonly string spatializationInfoSet3DTooltip =
            $"Sets the selected {NameOf.SoundContainer}s to Spatial Blend 1 and Distance Enabled." + EditorTrial.trialTooltip;
        ...
        public static readonly string spatializationInfoSet2DTooltip =
            $"Sets the selected {NameOf.SoundContainer}s to Spatial Blend 0 and Distance Disabled." + EditorTrial.trialTooltip;
        ...
        public static readonly string spatializationInfoEditAllTooltip =
            $"Edits all the selected {NameOf.SoundContainer}s." + EditorTrial.trialTooltip;
        ...
        public static readonly string spatializationInfoAllSelectACTooltip =
            $"Selects all AudioClips of the selected {NameOf.SoundContainer}s." + EditorTrial.trialTooltip;
        ...
        public static readonly string spatializationInfoAllSet3DTooltip =
            $"Sets all selected {NameOf.SoundContainer}s to Spatial Blend 1 and Distance Enabled." + EditorTrial.trialTooltip;
        ...
        public static readonly string spatializationInfoAllSet2DTooltip =
            $"Sets all selected {NameOf.SoundContainer}s to Spatial Blend 0 and Distance Disabled." + EditorTrial.trialTooltip;
        // Spatialization Info /////////////////////////////////////////////////////////////////////
        ...
        public static readonly string findReferencesSelectAllTooltip = $"Selects all the assets with references to the {NameOf.SoundContainer}." + EditorTrial.trialTooltip;
        ...
        // Warning
        public static readonly string disableVoiceEffectsWarning = "Voice Effects are Disabled, they will not have any effect";
        ...
        public static readonly string enableDistanceTooltip = $"Otherwise the {NameOf.SoundContainer} will not be affected by distance (disable for music etc)." + EditorTrial.trialTooltip;
        ...
        public static readonly string distanceScaleTooltip = 
            ...
            "\n" +
            $"It is multiplied by the Distance Scale of the {NameOf.SoundManager}." + EditorTrial.trialTooltip;
        ...
        public static readonly string distanceScaleIfXSetToYValueTooltip =
            $"Shows up if you have select multiple {NameOf.SoundContainer}s with Distance Enabled." +
            "\n" +
        ...
        public static readonly string followPositionTooltip = $"If the {NameOf.SoundContainer} should follow the given Transform position." + EditorTrial.trialTooltip;
        ...
        public static readonly string distanceScaleWarningLabel = $"Distance Scale is 0. The {NameOf.SoundContainer} will not be heard";
        ...
        public static readonly string noPlayOneShotOptimizationLabel = "No PlayOneShot Optimization";
        public static readonly string noPlayOneShotOptimizationTooltip =
           $"If \"Allow PlayOneShot Optimization\" is enabled in the SoundManager then then Sonity will play Voices with PlayOneShot() instead of Play()." + "\n" +
           "\n" +
           $"Some features are disabled when using PlayOneShot, like getting AudioSource.time and PreventEndClicks." + "\n" +
           "\n" +
           ...
           "\n" +
           $"This is only used under certain conditions:" + "\n" +
           $"Skipped if: Loop is enabled" + "\n" +
           $"Skipped if: Trigger On Tail is enabled" + "\n" +
           $"Skipped if: Random Start Position is enabled" + "\n" +
           $"Skipped if: Start Postion is more than 0" + "\n" +
           $"Skipped if: Follow Position is enabled, in the SoundContainer or Parameters" + "\n" +
           $"Enabled even with follow position if: Distance is disabled and Spatial Blend is 0" + "\n" +
           "\n" +
           $"Disabling PlayOneShot Optimization is useful if you need get etc AudioSource.time from oneshots etc." + EditorTrial.trialTooltip;
        ...
        public static readonly string neverStealVoiceTooltip =
            $"The {NameOf.SoundManager} will never steal this Voice if the Voice Limit is reached (use on music etc)." + EditorTrial.trialTooltip;
        ...
        public static readonly string neverStealVoiceEffectsTooltip =
            $"The {NameOf.SoundManager} will never steal the Voice Effects on this Voice if the Voice Effect Limit is reached (use on music etc)." + EditorTrial.trialTooltip;
        ...
        public static readonly string playOrderTooltip =
            ...
            "\n" +
            $"Local Random" + "\n" +
            $"Same as global random except its per {NameOf.SoundEvent} owner." + EditorTrial.trialTooltip;
        ...
        public static readonly string volumeTooltip =
            ...
            $"Option B:" + "\n" +
            "\n" +
            $"Select all the {NameOf.SoundContainer}s and lower the volume by -20 dB with the -1dB button." + "\n" +
            "\n" +
        ...
        public static readonly string volumeRelativeLowerTooltip = 
            ...
            "\n" +
            $"If multiple {NameOf.SoundContainer}s are selected it will show the lowest volume." + EditorTrial.trialTooltip;
        ...
        public static readonly string volumeRelativeIncreaseTooltip =
            ...
            "\n" +
            $"If multiple {NameOf.SoundContainer}s are selected it will show the highest volume." + EditorTrial.trialTooltip;
        ...
        public static readonly string volumeOverLimitWarning =
            ...
            $"Tip: Select all {NameOf.SoundContainer}s and press \"- 1dB\" until max is 0dB.";
        ...
        public static readonly string resetSettingsTooltip = $"Resets the {NameOf.SoundContainer} to the default options." + EditorTrial.trialTooltip;

        public static readonly string resetAllLabel = "Reset All";
        public static readonly string resetAllTooltip = $"Resets the {NameOf.SoundContainer} and the {nameof(AudioClip)}s to the default settings." + EditorTrial.trialTooltip;
    }
}
#endif