...
namespace Sonity.Internal {
    ...
    public static class EditorSoundEventModifierMenu {
        ...
        public static void ModifierReset(SerializedProperty settingProperty) {
            ...
            SerializedProperty force2D = settingProperty.FindPropertyRelative(nameof(SoundEventModifier.force2D));
            force2D.boolValue = true;
        ...
        public static void ModifierMenuShow(SoundEventModifier[] settings, UnityEngine.Object[] mTargets) {
            ...
            menu.AddItem(new GUIContent("Force 2D"), settings[0].force2DUse, ModifierMenuCallback, new MenuSetting(SoundParameterType.Force2D, settings, mTargets));
            menu.AddSeparator("");
        ...
        private static void ModifierMenuCallback(object obj) {
            ...
            for (int i = 0; i < menuSetting.soundEventModifier.Length; i++) {
                if (menuSetting.soundEventModifier[i] != null) {
                    ...
                    // Force 2D
                    else if (menuSetting.soundParameterType == SoundParameterType.Force2D) {
                        if (i == 0) {
                            tempUse = !menuSetting.soundEventModifier[0].force2DUse;
                        }
                        menuSetting.soundEventModifier[i].force2DUse = tempUse;
                    }
                    // Bypass Reverb Zones
