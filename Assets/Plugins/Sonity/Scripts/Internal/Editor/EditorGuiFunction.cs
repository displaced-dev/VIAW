...
namespace Sonity.Internal {
    public static class EditorGuiFunction {
        ...
        public static void DrawReordableArray(
            ...
            bool foldoutDraw = false, SerializedProperty foldoutProperty = null, string foldoutTitle = "", string foldoutToolip = "", bool foldoutMediumFont = false,
            bool hideSizeWhenUnfolded = false
            ) {
            ...
            if (foldoutDraw) {
                ...
                DrawFoldout(foldoutProperty, foldoutTitle, foldoutToolip, 0, false, !foldoutMediumFont, foldoutMediumFont);
                EndChange(serializedObject);
            }

            if (!foldoutDraw || (foldoutDraw && foldoutProperty.boolValue) || (foldoutDraw && foldoutProperty.boolValue && !hideSizeWhenUnfolded)) {
            ...
            // Foldout
            if (!foldoutDraw || (foldoutDraw && foldoutProperty.boolValue)) {
        ...
        public static void DrawFoldout(SerializedProperty expanded, string label, string tooltip = "", int indentLevel = 0, bool expandedBool = false, bool smallFont = false, bool mediumFont = false, bool verySmallFont = false, bool notBold = false, bool italic = false, Color? color = null) {
        ...
        public static bool DrawFoldoutBool(bool expanded, string label, string tooltip = "", int indentLevel = 0, bool expandedBool = false, bool smallFont = false, bool mediumFont = false, bool verySmallFont = false, bool notBold = false, bool italic = false, Color? color = null) {
            ...
            // Draw Toggle
            if (expandedBool) {
                return GUILayout.Toggle(expanded, new GUIContent(label, tooltip), guiStyle);
            } else {
                return GUILayout.Toggle(expanded, new GUIContent(label, tooltip), guiStyle);
            }
        }
