...
URP:
1) Make sure URP is installed, import SRP/URP.unitypackage by double clicking it.
...
HDRP:
1) Make sure HDRP is installed, import SRP/HDRP.unitypackage by double clicking it.
