...
URP:
1) Make sure URP is installed, import URP.unitypackage by double clicking it.
...
HDRP:
1) Make sure HDRP is installed, import HDRP.unitypackage by double clicking it.
