...
namespace Evo.UI
{
    ...
    public class Dropdown : MonoBehaviour
    {
        ...
        public void Open()
        {
            ...
            CacheCurrentPosition(); // Cache current positioning values right before opening
            CheckAndAdjustPosition(); // Check if dropdown would be off-screen and adjust position
